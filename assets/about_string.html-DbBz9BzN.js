import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as l,d as n,a as p,b as a,e as t,r as d,o as r}from"./app-D4fD6dZE.js";const c={};function u(v,s){const i=d("VPIcon");return r(),l("div",null,[s[2]||(s[2]=n(`<h2 id="_1、生成字符串与生成字符串切片" tabindex="-1"><a class="header-anchor" href="#_1、生成字符串与生成字符串切片"><span>1、生成字符串与生成字符串切片</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>//生成字符串为str的复制品s</span></span>
